...
vec4 gradient(float x)
{
	...
	const vec4 c3 = vec4(0.8, 0.1, 0., 0.05); 	// red 
...
void main() {
    ...
    float zoom = 4.4;//mouse.y / resolution.y * 5;//smoothstep(-1.,1., sin(time*0.2))*5.;
